...
public interface CListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterForCondition(@NotNull CParser.ForConditionContext ctx);
	/**
	 * Exit a parse tree produced by {@link CParser#forCondition}.
	 * @param ctx the parse tree
	 */
	void exitForCondition(@NotNull CParser.ForConditionContext ctx);
	 ...
	 * @param ctx the parse tree
	 */
	void enterForExpression(@NotNull CParser.ForExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link CParser#forExpression}.
	 * @param ctx the parse tree
	 */
	void exitForExpression(@NotNull CParser.ForExpressionContext ctx);
	 ...
	 * @param ctx the parse tree
	 */
	void enterForDeclaration(@NotNull CParser.ForDeclarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link CParser#forDeclaration}.
	 * @param ctx the parse tree
	 */
	void exitForDeclaration(@NotNull CParser.ForDeclarationContext ctx);
